...
export default function Books() {
  ...
  console.log('[Books] Component render - books:', books);
  console.log('[Books] Component render - isLoading:', isLoading);
  console.log('[Books] Component render - error:', error);
                ...
                <Box sx={{ flex: 1, minWidth: '300px' }}>
                  ...
                  <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
                    ...
                    <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                      ...
                      <Typography variant="body1">
                        <strong>Stok Durumu:</strong> {selectedBook.kitap_adet || 0} adet
                      </Typography>
                    </Box>
